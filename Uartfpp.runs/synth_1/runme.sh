...
HD_PWD='C:/Users/srika/Desktop/uart fp/Uartfpp/Uartfpp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart_rc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Uart_rc.tcl
