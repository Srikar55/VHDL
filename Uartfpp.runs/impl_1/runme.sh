...
HD_PWD='C:/Users/srika/Desktop/uart fp/Uartfpp/Uartfpp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart_rc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Uart_rc.tcl -notrace
